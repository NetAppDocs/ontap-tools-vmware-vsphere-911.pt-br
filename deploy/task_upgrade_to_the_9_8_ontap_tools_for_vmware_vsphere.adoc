...
[role="lead"]
Você pode realizar uma atualização in-place para a versão mais recente das ferramentas ONTAP a partir da sua versão atual 9.10 ou posterior, seguindo as instruções fornecidas aqui.
