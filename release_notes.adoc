...
Para obter mais informações, consulte https://library.netapp.com/ecm/ecm_download_file/ECMLP2883436["Ferramentas do ONTAP para notas de versão do VMware vSphere 9,11"^] .
